...
public class DataTransformer {
	...
	public static final String INPUT_BUCKET_NAME = "dima-test-12345";

	// TODO 2: Set output bucket name (must be globally unique)
	public static final String OUTPUT_BUCKET_NAME = "dima-test-12346";
	...
	private static S3Object getObject(AmazonS3 s3ClientForStudentBuckets2, String bucketName, String fileKey) {
		...
		return s3ClientForStudentBuckets2.getObject(new GetObjectRequest(bucketName, fileKey));
	}
	...
	private static URL generatePresignedUrl(String bucketName, String objectKey) {
		...
		// return Solution.generatePresignedUrl(s3ClientForStudentBuckets, bucketName,
		// objectKey);
	...
	private static PutObjectResult putObjectEnhanced(String bucketName, String fileKey, File transformedFile) {
		...
		metadata.addUserMetadata("contact", "John Doe");
		
		PutObjectRequest putRequest = new PutObjectRequest(bucketName, fileKey, transformedFile);
		putRequest.setMetadata(metadata);
		
		return s3ClientForStudentBuckets.putObject(putRequest);
